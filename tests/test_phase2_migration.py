...
def test_phase1_database_upgrades_once_to_phase2(tmp_path, monkeypatch):
    ...
    assert versions == {"001_phase1", "002_phase2_delivery_design", "003_ai_provider_telemetry", "004_phase3_execution_truth", "005_phase4_validation_acceptance", "006_phase4_5_pilot_integrations", "007_cloud_p1_async_auth"}
